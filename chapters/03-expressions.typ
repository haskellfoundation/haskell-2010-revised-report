...
#translation-box([
  ...
  the module `Data.Ratio` from the standard library.
...
#translation-box([
  ...
  are captured by this translation: After removing all type signatures, each declaration $d_i$ is translated into an equation with a proper pattern binding, $p_i = e_i$, where $p_i$ and $e_i$ are patterns and expressions
