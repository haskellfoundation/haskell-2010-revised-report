...
#table(
  ...
  align: (center,left),
  stroke: none,
  [\[#nontermname("pattern")\]],[optional],
  [{#nontermname("pattern")}],[zero or more repetitions],
  [(#nontermname("pattern"))],[grouping],
  [#nontermname("pat₁") | #nontermname("pat₂")],[choice],
  [$nontermname("pat")_(chevron.l nontermname("pat'") chevron.r)$],[difference---elements generated by #nontermname("pat") except those generated by #nontermname("pat'")],
...
#table(
  ...
  stroke: none,
  $nontermname("nonterm")$, $->$, $nontermname("alt₁") | nontermname("alt₂") | dots | nontermname("altₙ")$
)
...
#table(
  ...
  stroke: none,
  // program
  $nonterminal("program")$, $->$, ${ med nonterminal("lexeme") | nonterminal("whitespace") med }$,
  // lexeme
  $nonterminal("lexeme")$, $->$, $nonterminal("qvarid") | nonterminal("qconid") | nonterminal("qvarsym") | nonterminal("qconsym")$,
  [], $|$, $nonterminal("literal") | nonterminal("special") | nonterminal("reservedop") | nonterminal("reservedid")$,
  // literal
  $nonterminal("literal")$, $->$, $nonterminal("integer") | nonterminal("float") | nonterminal("char") | nonterminal("string")$,
  // special
  $nonterminal("special")$, $->$, $terminal("(") | terminal(")") | terminal(",") | terminal(";") | terminal("[") | terminal("]") | terminal("`") | terminal("{") | terminal("}")$,
  // whitespace
  $nonterminal("whitespace")$, $->$, $nonterminal("whitestuff") { nonterminal("whitestuff") }$,
  // whitestuff
  $nonterminal("whitestuff")$, $->$, $nonterminal("whitechar") | nonterminal("comment") | nonterminal("ncomment")$,
  // whitechar
  $nonterminal("whitechar")$, $->$, $nonterminal("newline") | nonterminal("vertab") | nonterminal("space") | nonterminal("tab") | nonterminal("uniWhite")$,
  // newline
  $nonterminal("newline")$, $->$, $nonterminal("return") nonterminal("linefeed") | nonterminal("return") | nonterminal("linefeed") | nonterminal("formfeed")$,
  // return
  $nonterminal("return")$, $->$, $text("a carriage return")$,
  // linefeed
  $nonterminal("linefeed")$, $->$, $text("a line feed")$,
  // vertab
  $nonterminal("vertab")$, $->$, $text("a vertical tab")$,
  // formfeed
  $nonterminal("formfeed")$, $->$, $text("a form feed")$,
  // space
  $nonterminal("space")$, $->$, $text("a space")$,
  // tab
  $nonterminal("tab")$, $->$, $text("a horizontal tab")$,
  // uniWhite
  $nonterminal("uniWhite")$, $->$, $text("any Unicode character defined as whitespace")$,
  // comment
  $nonterminal("comment")$, $->$, $nonterminal("dashes") [nonterminal("any")_(chevron.l nonterminal("symbol") chevron.r) { nonterminal("any") }] nonterminal("newline")$,
  // dashes
  $nonterminal("dashes")$, $->$, $terminal("--") { terminal("-") }$,
  // opencom
  $nonterminal("opencom")$, $->$, $terminal("{-")$,
  // closecom
  $nonterminal("closecom")$, $->$, $terminal("-}")$,
  // ncomment
  $nonterminal("ncomment")$, $->$, $nonterminal("opencom") nonterminal("ANYseq") { nonterminal("ncomment") nonterminal("ANYseq") } nonterminal("closecom")$,
  // ANYseq
  $nonterminal("ANYseq")$, $->$, ${ med nonterminal("ANY") med }_(chevron.l { med nonterminal("ANY") med } ( nonterminal("opencom") | nonterminal("closecom") ) { med nonterminal("ANY") med } chevron.r)$,
  // ANY
  $nonterminal("ANY")$, $->$, $nonterminal("graphic") | nonterminal("whitechar")$,
  // any
  $nonterminal("any")$, $->$, $nonterminal("graphic") | nonterminal("space") | nonterminal("tab")$,
  // graphic
  $nonterminal("graphic")$, $->$, $nonterminal("small") | nonterminal("large") | nonterminal("symbol") | nonterminal("digit") | nonterminal("special") | terminal("\"") | terminal("'")$,
  // small
  $nonterminal("small")$, $->$, $nonterminal("ascSmall") | nonterminal("uniSmall") | terminal("_")$,
  // ascSmall
  $nonterminal("ascSmall")$, $->$, $terminal("a") | terminal("b") | dots | terminal("z")$,
  // uniSmall
  $nonterminal("uniSmall")$, $->$, $text("any Unicode lowercase letter")$,
  // large
  $nonterminal("large")$, $->$, $nonterminal("ascLarge") | nonterminal("uniLarge")$,
  // ascLarge
  $nonterminal("ascLarge")$, $->$, $terminal("A") | terminal("B") | dots | terminal("Z")$,
  // uniLarge
  $nonterminal("uniLarge")$, $->$, $text("any uppercase or titlecase Unicode letter")$,
  // symbol
  $nonterminal("symbol")$, $->$, $nonterminal("ascSymbol") | nonterminal("uniSymbol")_(chevron.l nonterminal("special") | terminal("_") | terminal("\"") | terminal("'") chevron.r)$,
  // ascSymbol
  $nonterminal("ascSymbol")$, $->$, $terminal("!") | terminal("#") | terminal("$") | terminal("%") | terminal("&") | terminal("*") | terminal("+") | terminal(".")  | terminal("/") | terminal("<") | terminal("=") | terminal(">") | terminal("?") | terminal("@")$,
  [], $|$, $terminal("\\") | terminal("^") | terminal("|") | terminal("-") | terminal("~") | terminal(":")$,
  // uniSymbol
  $nonterminal("uniSymbol")$, $->$, $text("any Unicode symbol or punctuation")$,
  // digit
  $nonterminal("digit")$, $->$, $nonterminal("ascDigit") | nonterminal("uniDigit")$,
  // ascDigit
  $nonterminal("ascDigit")$, $->$, $terminal("0") | terminal("1") | dots | terminal("9")$,
  // uniDigit
  $nonterminal("uniDigit")$, $->$, $text("any Unicode decimal digit")$,
  // octit
  $nonterminal("octit")$, $->$, $terminal("0") | terminal("1") | dots | terminal("7")$,
  // hexit
  $nonterminal("hexit")$, $->$, $nonterminal("ascDigit") | terminal("A") | dots | terminal("F") | terminal("a") | dots | terminal("f")$,
)
...
#table(
  ...
  stroke: none,
  // varid
  $nonterminal("varid")$, $->$, $(nonterminal("small") {nonterminal("small") | nonterminal("large") | nonterminal("digit") | terminal("'") med })_(chevron.l nonterminal("reservedid") chevron.r)$,
  // conid
  $nonterminal("conid")$, $->$, $nonterminal("large") {nonterminal("small") | nonterminal("large") | nonterminal("digit") | terminal("'") med }$,
  // reservedid
  $nonterminal("reservedid")$, $->$, $terminal("case") | terminal("class") | terminal("data") | terminal("default") | terminal("deriving") | terminal("do") | terminal("else")$,
...
#table(
  ...
  stroke: none,
  // varsym
  $nonterminal("varsym")$, $->$, $( nonterminal("symbol")_(chevron.l terminal(":") chevron.r) { nonterminal("symbol")})_(chevron.l nonterminal("reservedop") | nonterminal("dashes") chevron.r)$,
  // consym
  $nonterminal("consym")$, $->$, $(terminal(":") { nonterminal("symbol") })_(chevron.l nonterminal("reservedop") chevron.r)$,
  // reservedop
  $nonterminal("reservedop")$, $->$, $terminal("..") | terminal(":") | terminal("::") | terminal("=") | terminal("\\") | terminal("|") | terminal("<-") | terminal("->") | terminal("@") | terminal("~") | terminal("=>")$,
)
...
#table(
  ...
  // tyvar
  $nonterminal("tyvar")$, $->$, $nonterminal("varid")$, [(type variables)],
  // tycon
  $nonterminal("tycon")$, $->$, $nonterminal("conid")$, [(type constructors)],
  // tycls
  $nonterminal("tycls")$, $->$, $nonterminal("conid")$, [(type classes)],
  // modid
  $nonterminal("modid")$, $->$, ${ nonterminal("conid") terminal(".")} nonterminal("conid")$, [(modules)],
)
...
four do not.
Module names are a dot-separated sequence of $nonterminal("conid")$s.
...
#table(
  ...
  stroke: none,
  // qvarid
  $nonterminal("qvarid")$, $->$, $[nonterminal("modid") terminal(".")] nonterminal("varid")$,
  // qconid
  $nonterminal("qconid")$, $->$, $[nonterminal("modid") terminal(".")] nonterminal("conid")$,
  // qtycon
  $nonterminal("qtycon")$, $->$, $[nonterminal("modid") terminal(".")] nonterminal("tycon")$,
  // qtycls
  $nonterminal("qtycls")$, $->$, $[nonterminal("modid") terminal(".")] nonterminal("tycls")$,
  // qvarysm
  $nonterminal("qvarsym")$, $->$, $[nonterminal("modid") terminal(".")] nonterminal("varsym")$,
  // qconsym
  $nonterminal("qconsym")$, $->$, $[nonterminal("modid") terminal(".")] nonterminal("consym")$,
...
#table(
  ...
  stroke: none,
  // decimal
  $nonterminal("decimal")$, $->$, $nonterminal("ascDigit"){nonterminal("digit")}$,
  // octal
  $nonterminal("octal")$, $->$, $nonterminal("octit"){nonterminal("octit")}$,
  // hexadecimal
  $nonterminal("hexadecimal")$, $->$, $nonterminal("hexit"){nonterminal("hexit")}$,
  // integer
  $nonterminal("integer")$, $->$, $nonterminal("decimal")$,
  ...
  // float
  $nonterminal("float")$, $->$, $nonterminal("decimal") terminal(".") nonterminal("decimal") [ nonterminal("exponent")]$,
  [], $|$, $nonterminal("decimal") nonterminal("exponent")$,
  // exponent
  $nonterminal("exponent")$, $->$, $(terminal("e") | terminal("E")) [terminal("+") | terminal("-")] nonterminal("decimal")$,
)
...
#table(
  ...
  stroke: none,
  // char
  $nonterminal("char")$, $->$, $terminal("'") (nonterminal("graphic")_(chevron.l terminal("'") | terminal("\\") chevron.r) | nonterminal("space") | nonterminal("escape")_(chevron.l terminal("\&") chevron.r)) terminal("'")$,
  // string
  $nonterminal("string")$, $->$, $terminal("\"") {nonterminal("graphic")_(chevron.l terminal("\"") | terminal("\\") chevron.r) | nonterminal("space") | nonterminal("escape") | nonterminal("gap") } terminal("\"")$,
  // escape
  $nonterminal("escape")$, $->$, $terminal("\\") (nonterminal("charesc") | nonterminal("ascii") | nonterminal("decimal") | terminal("o") nonterminal("octal") | terminal("x") nonterminal("hexadecimal"))$,
  // charesc
  $nonterminal("charesc")$, $->$, $terminal("a") | terminal("b") | terminal("f") | terminal("n") | terminal("r") | terminal("t") | terminal("v") | terminal("\\") | terminal("\"") | terminal("'") | terminal("&")$,
  // ascii
  $nonterminal("ascii")$, $->$, $terminal("^") nonterminal("cntrl") | terminal("NUL") | terminal("SOH") | terminal("STX") | terminal("ETX") | terminal("EOT") | terminal("ENQ") | terminal("ACK")$,
  ...
  // cntrl
  $nonterminal("cntrl")$, $->$, $nonterminal("ascLarge") | terminal("@") | terminal("[") | terminal("\\") | terminal("]") | terminal("^") | terminal("_")$,
  // gap
  $nonterminal("gap")$, $->$, $terminal("\\") nonterminal("whitechar") { med nonterminal("whitechar") med } terminal("\\")$,
)
...
escaped.  The category $nonterminal("charesc")$ also includes portable
